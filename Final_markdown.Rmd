...
Next we plotted the frequency of delays of more than 5 minutes by time of day. The spread of the amount of late trains is included in the plot below.
...
df %>%
  ...
  plotTheme() +
  labs(title = "Average Delays by Line",
       x = "Hour")
```
## Station delays
```{r fig.height=12}

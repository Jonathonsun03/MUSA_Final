...
pacman::p_load(tidyverse, vroom, DataExplorer, lubridate, sf, tidycensus, tigris, hms, riem, slider, scales, caret,RcppEigen, ckanr, FNN, grid, gridExtra, gtools, httr, kableExtra, modelsummary,tidycensus, spdep, stargazer, tmap, viridis, zipcodeR, DT, dplyr, scales, ggthemes, plotly, gganimate)
...
df <- df %>%
  ...
  mutate(date = ymd(date),
         ...
         # Time lag dumb used to get the lag of the station previous in station sequence
...
remove <- c("ID","from_id","to_id","train_id","type","interval60","line","date","scheduled_datetime",
            "actual_datetime","Actual_time","accumulated_delay", "quintile_delay", "AM_PM")

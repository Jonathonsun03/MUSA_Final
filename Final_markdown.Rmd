...
ColNamesClean <- as_tibble(colnames(df %>%
                                      select(!remove))) %>%
                    rename(Name = value) %>%
...
Freishtat, S. (2021). Waiting longer for Follow your bus or train? The CTA has been running fewer of them during the pandemic. 5.
Lazo, L. (n.d.). Amtrak’s chronic delays are costing millions of dollars, report says. 2.
Penney, V. (2021). How Coronavirus Has Changed New York City Transit, in One Chart. 7.
